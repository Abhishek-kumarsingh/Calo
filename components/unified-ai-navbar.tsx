...
import { chatSessionApi } from '@/lib/api-utils';
import {
  Sparkles,
  ChevronDown,
  Lightbulb,
...
interface UnifiedAINavbarProps {
...
export function UnifiedAINavbar({ 
  onPromptSelect, 
  onNewChat, 
  onToggleSidebar,
  sidebarCollapsed = false
}: UnifiedAINavbarProps) {
    ...
    <header className="sticky top-0 z-40 border-b bg-background">
      <div className="flex h-16 items-center justify-between px-4">
        <div className="flex items-center gap-2">
          ...
          <div className="h-6 mx-4 border-l border-muted-foreground/20"></div>
        ...
        <div className="flex items-center gap-2">
          ...
          {/* History Button */}
          <Button variant="ghost" size="sm" className="gap-1" onClick={onToggleSidebar}>
